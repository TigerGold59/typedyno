    ...
    async activate(
        ...
        switch (jumprole_result.type) {
            ...
            case GetJumproleResultType.InvalidServerSnowflake: {
                log(
                    `proof remove: Jumprole.Get with arguments [${values.jumprole_name}, ${interaction.guild.id}] failed with error GetJumproleResultType.InvalidServerSnowflake.`,
                    LogType.Error,
                );
                await reply(
            ...
            case GetJumproleResultType.GetTierWithIDFailed: {
                ...
                log(
                    `proof remove: Jumprole.Get with arguments [${values.jumprole_name}, ${interaction.guild.id}] unexpectedly failed with error GetJumproleResultType.GetTierWithIDFailed.`,
                    LogType.Error,
                );
            ...
            case GetJumproleResultType.Unknown: {
                log(
                    `proof remove: Jumprole.Get with arguments [${values.jumprole_name}, ${interaction.guild.id}] unexpectedly failed with error GetJumproleResultType.Unknown.`,
                );
            ...
            case GetJumproleResultType.Success: {
                ...
                switch (result.type) {
                    ...
                    case GetJumproleEntryByJumproleAndHolderResultType.InvalidHolderSnowflake: {
                        log(
                            `proof remove: JumproleEntry.Get did not accept holder snowflake '${interaction.author.id}'. Returning status to indicate failure...'`,
                            LogType.Error,
                        );
